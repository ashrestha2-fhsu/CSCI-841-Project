...
//   contributionFrequency: ContributionFrequency;
//   accountId: string; // for contribute
//   // not shown in UI, but we’ll set on create
//   status?: SavingsGoalStatus;
// };
...
//   // fetch accounts for contribute mode
//   useEffect(() => {
//     const fetchAccounts = async () => {
//       if (mode !== "contribute") return;
//       try {
...
//     const n = Number(val);
//     return Number.isFinite(n) ? n : 0;
//     // If you want to preserve decimals precisely, parse as string and let backend BigDecimal handle it via body JSON.
//   };
...
//           {
//             params: {
//               amount: toNumberOrZero(form.currentAmount),
//               accountId: form.accountId ? Number(form.accountId) : undefined,
//             },
//           }
//         );
//       } else {
//         // CREATE — include status=ACTIVE to match backend expectations
//         await axiosInstance.post("/savings-goals", {
//           goalName: form.goalName.trim(),
//           targetAmount: toNumberOrZero(form.targetAmount),
//           currentAmount: toNumberOrZero(form.currentAmount),
...
//           priorityLevel: form.priorityLevel,
//           contributionFrequency: form.contributionFrequency,
//           status: SavingsGoalStatus.ACTIVE, // 👈 important (also handled by mapper default now)
//           userId,
//         });
//       }
...
//     } catch (err) {
//       console.error(err);
//       setError("Failed to submit savings goal. Please check your inputs.");
//     } finally {
//       setSubmitting(false);
//     }
//   };
